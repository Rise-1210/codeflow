...
#修改输入输出地址和模型地址
OUTPUT_DIR="/mnt/public/code/wangzr/mds/multi-turn_code/output/test2"
INPUT_DIR="/mnt/public/code/wangzr/mds/multi-turn_code/codeflowbench_sample.json"
MODEL_PATH = "/mnt/public/code/wangzr/mds/Qwen2.5-7B-Instruct"
...
for problem in data:
    ...
    for subproblem in subproblems:
        ...
        #加入系统提示词
        input_all=[{"role":"system","content":"You are a helpful assistant"},{"role": "user", "content": input}]
        generated = chat_model.generate(input_all)
        output=generated[0].outputs[0].text
        output=extract_code(output) #改成大模型给出的回复 
        print(output) 
